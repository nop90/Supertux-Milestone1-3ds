...
APP_TITLE		:= Supertux 
APP_DESCRIPTION	:= SuperTux is a free classic 2D jump'n run sidescroller game in a style similar to the original Super Mario games
...
CFLAGS	+=	$(INCLUDE) -DARM11 -D_3DS  -DRES320X240 -DNOOPENGL -DUSEMIKMOD

CXXFLAGS	:= $(CFLAGS) -fno-rtti -fno-exceptions -findirect-inlining -fpermissive
